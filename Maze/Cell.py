...
class Cell:
    ...
    def __init__(self, x: int, y: int,
                 color: Optional[Union[tuple[int, int, int], pygame.Surface]]
                 ) -> None:
        """Initialize the cell."""
        self._n = True
        self._s = True
    ...
    def set_render_cell(self) -> None:
        """Build the cell wall render blocks."""
        self.reset_render()
    ...
    def __set_render_item(self, item: pygame.Surface) -> None:
        """Add a texture to the render blocks."""
        size = GameState.get_cell_size()
